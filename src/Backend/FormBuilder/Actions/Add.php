...
class Add extends BackendBaseActionAdd
{
    ...
    /**
     * The available templates for the Form
     *
     * @var array
     */
    private $templatesForm = [];
    ...
    public function execute(): void
    {
        ...
        $this->templatesForm = BackendFormBuilderModel::getTemplatesForm();
        $this->loadForm();
        $this->validateForm();
        $this->parse();
        $this->display();
    ...
    private function loadForm(): void
    {
        ...
        // if we have multiple templates for the form, add a dropdown to select them
        if (count($this->templatesForm) > 1) {
            $this->form->addDropdown('templateForm', array_combine($this->templatesForm, $this->templatesForm));
        }
        ...
        if ($this->form->isSubmitted()) {
            ...
            if ($this->form->isCorrect()) {
                ...
                $values['email_template'] = count($this->templates) > 1
                 ...
                 $values['form_template'] = count($this->templatesForm) > 1
                    ? $this->form->getField('templateForm')->getValue() : $this->templatesForm[0];               
